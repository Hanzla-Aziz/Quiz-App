                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        ...
                                        $query = "SELECT * FROM attempted_quiz INNER JOIN category ON `attempted_quiz`.`cat_id` = `category`.`category_id` WHERE `attempted_quiz`.`user_id` = '$user_id'";
                                            ...
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    $question = $row['no_of_question'];
                                                    $correct_attempt = $row['correct_attempt'];
                                                    $wrong_attempt = $row['wrong_attemp'];
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php if(isset($q_id)){echo $q_id; } ?></td>
                                                        <td><?php if(isset($question)){echo $question; } ?></td>
                                                        <td><?php if(isset($correct_attempt)){echo $correct_attempt; } ?></td>
                                                        <td><?php if(isset($wrong_attempt)){echo $wrong_attempt; } ?></td>
                                                        <td><?php if(isset($not_attempt)){echo $not_attempt; } ?></td>
